...
/* at Wed Feb 26 21:04:49 2003
 */
/* Compiler settings for E:\LibKN\ComWin32\LibKNCom.idl:
...
EXTERN_C const IID IID_IMessageEntry;
    ...
    MIDL_INTERFACE("CAAB334A-BFE6-4C73-9DE3-7A052DA43B62")
...
EXTERN_C const IID IID_IMessage;
    ...
    MIDL_INTERFACE("9FED2E8D-A992-4DA9-872C-110C55B1AF92")
    ...
    public:
        ...
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE GetAsSimpleFormat( 
            /* [retval][out] */ BSTR __RPC_FAR *pVal) = 0;
        
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE InitFromSimple( 
            /* [in] */ BSTR str,
            /* [retval][out] */ VARIANT_BOOL __RPC_FAR *pVal) = 0;
    ...
    typedef struct IMessageVtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetAsSimpleFormat )( 
            IMessage __RPC_FAR * This,
            /* [retval][out] */ BSTR __RPC_FAR *pVal);
        
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *InitFromSimple )( 
            IMessage __RPC_FAR * This,
            /* [in] */ BSTR str,
            /* [retval][out] */ VARIANT_BOOL __RPC_FAR *pVal);
...
#define IMessage_GetAsSimpleFormat(This,pVal)	\
    (This)->lpVtbl -> GetAsSimpleFormat(This,pVal)

#define IMessage_InitFromSimple(This,str,pVal)	\
    (This)->lpVtbl -> InitFromSimple(This,str,pVal)
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE IMessage_GetAsSimpleFormat_Proxy( 
    IMessage __RPC_FAR * This,
    /* [retval][out] */ BSTR __RPC_FAR *pVal);


void __RPC_STUB IMessage_GetAsSimpleFormat_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE IMessage_InitFromSimple_Proxy( 
    IMessage __RPC_FAR * This,
    /* [in] */ BSTR str,
    /* [retval][out] */ VARIANT_BOOL __RPC_FAR *pVal);


void __RPC_STUB IMessage_InitFromSimple_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
EXTERN_C const IID IID_IComRequestStatusHandler;
    ...
    MIDL_INTERFACE("72AE2756-8E4C-4eca-AE07-16E49439B177")
...
EXTERN_C const IID IID_IComListener;
    ...
    MIDL_INTERFACE("42A593D0-96CF-4feb-BB54-C6AA44DE1C30")
...
EXTERN_C const IID IID_IParameters;
    ...
    MIDL_INTERFACE("0B3E3DD2-AF93-4FA7-8243-6D8B10BDD8F1")
...
EXTERN_C const IID IID_IConnector;
    ...
    MIDL_INTERFACE("AA24822F-7377-44B2-8FDC-B0569C2EBDBF")
    ...
    public:
        ...
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE Publish( 
            ...
            /* [optional][in] */ IComRequestStatusHandler __RPC_FAR *sh) = 0;
        
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE Subscribe( 
            /* [in] */ BSTR topic,
            /* [optional][in] */ IComListener __RPC_FAR *listener,
            /* [optional][in] */ IMessage __RPC_FAR *options,
            /* [optional][in] */ IComRequestStatusHandler __RPC_FAR *sh,
            /* [retval][out] */ BSTR __RPC_FAR *pVal) = 0;
    ...
    typedef struct IConnectorVtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *Unsubscribe )( 
            IConnector __RPC_FAR * This,
            /* [in] */ BSTR rid,
            /* [optional][in] */ IComRequestStatusHandler __RPC_FAR *sh,
            /* [retval][out] */ VARIANT_BOOL __RPC_FAR *pVal);
...
#define IConnector_Subscribe(This,topic,listener,options,sh,pVal)	\
    (This)->lpVtbl -> Subscribe(This,topic,listener,options,sh,pVal)

#define IConnector_Unsubscribe(This,rid,sh,pVal)	\
    (This)->lpVtbl -> Unsubscribe(This,rid,sh,pVal)
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE IConnector_Subscribe_Proxy( 
    IConnector __RPC_FAR * This,
    /* [in] */ BSTR topic,
    /* [optional][in] */ IComListener __RPC_FAR *listener,
    /* [optional][in] */ IMessage __RPC_FAR *options,
...
void __RPC_STUB IConnector_Subscribe_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE IConnector_Unsubscribe_Proxy( 
    IConnector __RPC_FAR * This,
    /* [in] */ BSTR rid,
    /* [optional][in] */ IComRequestStatusHandler __RPC_FAR *sh,
    /* [retval][out] */ VARIANT_BOOL __RPC_FAR *pVal);
...
void __RPC_STUB IConnector_Unsubscribe_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
EXTERN_C const IID DIID__IConnectorEvents;
    ...
    MIDL_INTERFACE("F91E756A-C698-42ba-BDDC-D93971125AA9")
