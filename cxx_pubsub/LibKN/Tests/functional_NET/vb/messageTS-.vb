...
Public Class messageTS
    ...
    Public Sub testEquals()
        ...
        Assertion.Assert("m1.IsEqual(m2)", m1.IsEqual(m2) = False)
    End Sub
    ...
    Public Sub testGet()
        ...
        Assertion.Assert("", str1 = "Value1")

        result = m1.Get("field5", str1)
        Assertion.Assert("result = False", result = False)
    End Sub
